...
sender = "senderuser@gmail.com"
password = "pvjf mjtq zbki abul" # uar contraseña de aplicación de gmail: app password https://myaccount.google.com/u/4/apppasswords
receivers = ['receiveruser@gmail.com']
